...
static_text_command! {
    ...
    mcsr "ranked" "speedrun",
        "MCSR requires Java 17 and should be installed following the instructions on this page for the respective OS: <https://github.com/MultiMC/Launcher/wiki/Using-the-right-Java>",
